...
export function NotificationSystem() {
  ...
  return (
    <div className="relative" ref={notificationRef}>
      <button className="btn btn-ghost btn-icon relative" onClick={() => setShowNotifications(!showNotifications)}>
        <svg
      ...
      {showNotifications && (
        <div className="dropdown-content fade-in" style={{ width: "320px" }}>
            ...
            {notifications.length === 0 ? (
              ...
              <div>
                {notifications.map((notification) => (
                  <div key={notification.id} className={`p-3 border-b ${notification.read ? "" : "bg-primary-light"}`}>
                    <div className="flex items-start gap-3">
                      <div className="avatar">{getInitials(notification.sender)}</div>
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-light">{notification.message}</p>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="text-xs text-light">
                              ...
                              {countWords(replyContent) > 50 && <span className="text-error ml-2">Reply too long</span>}
                            </div>
                            <button
